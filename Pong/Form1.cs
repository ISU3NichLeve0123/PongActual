...
namespace Pong
{
    public partial class Form1 : Form
    {
        ...
        private void GameOver(string Winner)
        {
            ...
            this.Refresh();
            Thread.Sleep(2000);
            startLabel.Text = "Press Y if you want to restrat the game";
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
                ...
                e.Graphics.DrawString(player1Score.ToString(), drawFont, drawBrush, this.Width - 20, 20);
                e.Graphics.DrawString(player2Score.ToString(), drawFont, drawBrush, 10, 25);
